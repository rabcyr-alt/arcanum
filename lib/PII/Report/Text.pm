...
PII::Report::Text - Human-readable text report for pii-guardian
...
sub render {
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    $self->_print_header("pii-guardian scan report \x{2014} $ts");
