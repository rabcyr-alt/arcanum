package PII::Remediation::Quarantine;
...
PII::Remediation::Quarantine - File quarantine remediation for pii-guardian

=head1 DESCRIPTION

Moves files to a quarantine directory, mirroring the source directory
structure. Writes a C<.pii-guardian-meta> sidecar JSON file alongside
...
sub quarantine {
    ...
    my $q_dir_rel = $cfg->{quarantine_dir} // '.pii-guardian-quarantine';
    ...
    my $meta_path = Path::Tiny->new("${dest}.pii-guardian-meta");
