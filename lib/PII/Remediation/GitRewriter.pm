package PII::Remediation::GitRewriter;
...
PII::Remediation::GitRewriter - Git history rewrite plan generator for pii-guardian
...
sub _script_content {
    ...
    push @lines, '# Generated by pii-guardian ' . $ts;
