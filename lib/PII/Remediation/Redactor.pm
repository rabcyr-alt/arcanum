package PII::Remediation::Redactor;
...
PII::Remediation::Redactor - Format-aware in-place redaction for pii-guardian
...
C<$path.pii-guardian-backup-YYYYMMDDHHMMSS>. After the edit, both SHA-256
