...
PII::Format::Base - Abstract base class for pii-guardian format parsers

=head1 SYNOPSIS

    package PII::Format::MyFormat;
...
sub new {
    ...
    croak "PII::Format::Base is abstract; subclass it and implement can_handle() and parse()"
        if $class eq 'PII::Format::Base';
