package PII::Notification::Email;
...
PII::Notification::Email - SMTP email notification backend for pii-guardian
...
sub send {
    ...
    my $from    = $cfg->{from}             // 'pii-guardian@localhost';
    my @to      = @{ $cfg->{to}            // [] };
    ...
    my $subject = $payload->{subject} // 'pii-guardian: PII findings detected';
