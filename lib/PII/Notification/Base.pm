...
PII::Notification::Base - Abstract base for pii-guardian notification backends
...
=head2 Notification payload structure
    ...
    {
        subject     => "pii-guardian: PII found in <repo>",
...
sub new {
    ...
    croak "PII::Notification::Base is abstract; subclass it"
        if $class eq 'PII::Notification::Base';
...
sub build_body {
    ...
    my @lines;
    push @lines, "pii-guardian notification — $ts";
    push @lines, "=" x 60;
    push @lines, '';
