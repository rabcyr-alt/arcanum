package App::Arcanum::Remediation::Deleter;
...
App::Arcanum::Remediation::Deleter - File deletion remediation for arcanum
...
Inherits from C<App::Arcanum::Remediation::Base>. Checks for the C<shred> binary
