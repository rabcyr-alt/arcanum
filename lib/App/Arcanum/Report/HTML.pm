package App::Arcanum::Report::HTML;
...
App::Arcanum::Report::HTML - Self-contained HTML report for arcanum

=head1 SYNOPSIS

    my $rpt = App::Arcanum::Report::HTML->new(config => $cfg, logger => $log);
...
<title>arcanum report &mdash; $esc_ts</title>
<style>
/* ── Reset / base ── */
...
<footer>Generated by arcanum</footer>
<script>
