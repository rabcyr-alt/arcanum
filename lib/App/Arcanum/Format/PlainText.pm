package App::Arcanum::Format::PlainText;
...
App::Arcanum::Format::PlainText - Plain-text format parser for arcanum

=head1 SYNOPSIS

    my $parser = App::Arcanum::Format::PlainText->new(config => $cfg, logger => $log);
