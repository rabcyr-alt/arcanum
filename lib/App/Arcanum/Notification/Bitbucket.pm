package App::Arcanum::Notification::Bitbucket;
...
App::Arcanum::Notification::Bitbucket - Bitbucket Cloud and Server notification backend
...
sub _send_cloud {
    ...
    my $title = $payload->{subject}  // 'arcanum: PII findings';
